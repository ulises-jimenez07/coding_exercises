"""
Problem: Find the town judge who is trusted by everyone but trusts nobody.

Approach:
- Calculate in-degree (trusted by) and out-degree (trusts) for each person
- Judge has in-degree of n-1 and out-degree of 0
- Time complexity: O(E + V) where E is trust relationships
- Space complexity: O(V) for degree arrays
"""
