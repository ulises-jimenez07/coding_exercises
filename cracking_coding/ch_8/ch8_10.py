...
def flood_fill(screen: List[List[int]], r: int, c: int, old_color, new_color: int):
    if r < 0 or r >= len(screen) or c < 0 or c >= len(screen[0]) or screen[r][c] != old_color:
        return
...
if __name__ == "__main__":
    print(paint_fill([[1, 2, 5], [2, 2, 4], [2, 8, 6]], 1, 1, 3))
